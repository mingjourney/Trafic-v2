...
const KeyStationCharts = ({
  ...
  const renderChart = useCallback(
    (singleStationFlow: {
      ...
      const markTime = singleStationFlow[key][singleStationFlow[key].length - 7]?.time ?? "";
      chart.setOption({
        tooltip: {
          trigger: "axis",
        },
  ...
  }, [station, eitherInOut, renderChart, dataProvider, state]);
...
export default KeyStationCharts;
